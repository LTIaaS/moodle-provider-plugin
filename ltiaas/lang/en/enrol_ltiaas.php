...
$string['customdescription_help'] = 'Replaces the module or resource description.';
...
$string['enrolisdisabled'] = 'The \'Publish as LTI Advantage tool with LTIAAS\' plugin is disabled.';
...
$string['launchurl_help'] = 'Launch URL';
$string['ltiaasapikey'] = 'Ltiaas API Key';
...
$string['ltiaas:config'] = 'Configure \'Publish as LTI Advantage tool with LTIAAS\' instances';
$string['ltiaas:unenrol'] = 'Unenrol users from the course';
$string['opentool'] = 'Open tool';
$string['pluginname'] = 'Publish as LTI Advantage tool with LTIAAS';
$string['pluginname_desc'] = 'The \'Publish as LTI Advantage tool with LTIAAS\' plugin, together with the LTI authentication plugin, allows remote users to access selected courses and activities. In other words, Moodle functions as an LTI tool provider.';
...
$string['sharedexternaltools'] = 'Published as LTI Advantage tools with LTIAAS';
$string['successfulregistration'] = 'Successful registration';
$string['tasksyncgrades'] = 'Publish as LTI Advantage tool with LTIAAS - Tool grade sync';
$string['tasksunenrolusers'] = 'Publish as LTI Advantage tool with LTIAAS - Unenrol expired LTI users';
$string['tasksyncmembers'] = 'Publish as LTI Advantage tool with LTIAAS users sync';
$string['toolsprovided'] = 'Published LTI Advantage tools';
...
$string['userdefaultvalues'] = 'LTI Provider Configuration';
